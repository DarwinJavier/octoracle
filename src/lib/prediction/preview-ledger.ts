...
const RECORDED_PREVIEW_PREDICTIONS = {
  ...
  "537369": publicPredictionSchema.parse({
    ...
    predictedScoreB90: 0,
    publicExplanation:
      "FIFA ranks Spain #2 and Cape Verde #67. The reviewed forecast favored Spain clearly while retaining uncertainty around the final margin.",
    reasonCodes: ["reviewed_forecast", "stronger_forecast"],
    selectedOutcome: "team_a",
    sourceCount: 1,
    status: "published",
  ...
  "537363": publicPredictionSchema.parse({
    ...
    predictedScoreB90: 1,
    publicExplanation:
      "FIFA ranks Belgium #9 and Egypt #29. The reviewed forecast gives Belgium the stronger outlook while preserving meaningful Egypt and draw chances.",
    reasonCodes: ["reviewed_forecast", "stronger_forecast"],
    selectedOutcome: "team_a",
    sourceCount: 1,
    status: "published",
  ...
  "537364": publicPredictionSchema.parse({
    ...
    predictedScoreB90: 0,
    publicExplanation:
      "FIFA ranks Iran #20 and New Zealand #85. The reviewed forecast favored Iran clearly while retaining uncertainty around the final margin.",
    reasonCodes: ["reviewed_forecast", "stronger_forecast"],
    selectedOutcome: "team_a",
    sourceCount: 1,
    status: "published",
